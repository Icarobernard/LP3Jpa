                        ...
                        <c:forEach items="${trabalhos}" var="trabalho">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <c:out value="${trabalho.dataFim}" /><!--talvez tenha que tirar-->
                                    </td>
                                    <td>
                                        <c:out value="${trabalho.dataInicio}" /><!--talvez tenha que tirar-->
                                    </td>
                                    <td>
                                   
                                        <a  href="ManterTrabalhoController?acao=prepararOperacao&operacao=Editar&id=<c:out
                                               value="${trabalho.id}" />" >Editar <i class="fas fa-user-edit"></i></a>
                                       
                                        
                                    
                                        <c:if test="${sessionScope.tipo != 'cliente'}">
                                   <a style="color: lawngreen" href="ManterTrabalhoController?acao=prepararOperacao&operacao=Excluir&id=<c:out
                                               value="${trabalho.id}" />" >Atender <i class="fas fa-check"></i> </a></td>
                                        </c:if>     
                                </tr>
                            </c:forEach>
                        </tbody>
