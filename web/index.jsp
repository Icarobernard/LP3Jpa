...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function n(e) {
            return Math.floor(e)
            }             function o() {             var e = S.params.autoplay, a = S.slides.eq(S.activeIndex);
            ...
            a = a || {};
                    ...
                    e.forEach(function (e) {                     S.onResize(!0), S.emit("onObserverUpdate", S, e)
                    })
                    });
            ...
            var t = !1;
                    ...
                    return;                     var s = {left: window.pageXOffset, top: window.pageYOffset}, i = window.innerWidth, r = window.innerHeight, n = S.container.offset();
            ...
            S.wrapper.children("." + S.params.slideClass + "." + S.params.slideDuplicateClass).remove();
                    ...
                    var t, s = [], i = [];
                    for (e.each(function(t, r){var n = a(this); t < S.loopedSlides && i.push(r), t < e.length && t >= e.length - S.loopedSlides && s.push(r), n.attr("data-swiper-slide-index", t)}), t = 0; t < i.length; t++)
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg mb-4 top-bar navbar-static-top sps sps--abv">
            <div class="container">
                ...
                <a class="navbar-brand mx-auto" href="#">Gra<span>rante</span></a>
                <div class="collapse navbar-collapse" id="navbarCollapse1">
                    <ul class="navbar-nav ml-auto">
                        
                        <li class="nav-item active"> <a class="nav-link" href="#myCarousel">Home <span class="sr-only">(current)</span></a> </li>
                     <!--   <li class="nav-item"> <a class="nav-link" href="#benefits">Benefício</a></li>
                        <li class="nav-item"> <a class="nav-link" href="#about">Sobre</a> </li> -->
                        <c:if test="${sessionScope.tipo != null}">
                        <c:if test="${sessionScope.tipo == 'anunciante'}">
                            <li class="nav-item"> <a class="nav-link" href="ClienteController?acao=Only">Garçons</a> </li>
                            <li class="nav-item"> <a class="nav-link" href="AnuncianteController?acao=Only">Administradores</a></li>
                            <li class="nav-item"> <a class="nav-link" href="ProdutoController?acao=Only">Produtos</a></li>
                            <!-- <li class="nav-item"> <a class="nav-link" href="PesquisaRequisicaoController">Requisicao</a> </li> -->
                        </c:if> 

                        <li class="nav-item"> <a class="nav-link" href="PedidoController?acao=Only">Pedidos</a> </li>
                        

                       </c:if>   
                        <li class="nav-item"> <a class="nav-link" href="#" style="text-decoration:none">Bem-vindo ${sessionScope.nome}</a></li>
                        <c:if test="${sessionScope.tipo == null}">
                        <li class="nav-item"> <a href="#" id="myBtn" class="btn btn-transparent-white btn-capsul">Login <i class="fas fa-sign-in-alt"></i> </a> </li>
                         </c:if> 
                        
                        
                        <c:if test="${sessionScope.tipo != null}">
                        <li class="nav-item"> <a href="LogoutController" class="btn btn-transparent-white btn-capsul">Logout <i class="fas fa-sign-out-alt"></i></a> </li>
                        </c:if> 
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content" align="center">
    ...
    <div class="nav-item"> <a href="loginAnunciante.jsp" id="myBtn" class="btn btn-transparent-white btn-capsul">Logar como Administrador</a> </div>

    <div class="nav-item"> <a href="login.jsp" id="myBtn" class="btn btn-transparent-white btn-capsul">Logar como garçon</a> </div>
  </div>
    ...
    modal.style.display = "none";
        ...
        <div class="swiper-container main-slider" id="myCarousel">
            <div class="swiper-wrapper">
                <div class="swiper-slide slider-bg-position" style="background:url('https://i.pinimg.com/originals/b0/0e/a0/b00ea076474d7817adfca923fc3b521f.gif')" data-hash="slide1">
                    <h2>"Forneça as ferramentas para permitir que as pessoas se transformem no seu melhor"</h2>
                </div>
        ...
        <section class="service-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heading">
                            <h2><small>Beneficíos de ser voluntário</small>Entenda como pode te favorecer</h2>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-6 text-sm-center service-block"> 
                                <h3>O voluntariado é bom para o corpo e a mente</h3>
                                <p>O voluntariado pode dar um impulso saudável para a sua auto-confiança, auto-estima e satisfação com a vida. Fazer o bem para os outros e para a comunidade proporciona uma sensação natural de realização.
                                    Seu papel como um voluntário também pode dar-lhe um sentimento de orgulho e realização. É a melhor sensação que podemos sentir.</p>
                            </div>
                            <div class="col-md-6 text-sm-center service-block"> 
                                <h3>Combate a depressão</h3>
                                <p>A redução do risco de depressão é outro benefício importante do voluntariado. Um fator de risco chave para a depressão é o isolamento social e ser voluntário mantém você em contato frequente com os outros e ajuda a eliminar o stress.
                                    Trabalhar com animais de estimação é comprovadamente um dos melhores métodos para diminuir o stress, melhorar o humor e acabar com a ansiedade.</p>
                            </div>
                            <div class="col-md-6 text-sm-center service-block"> 
                                <h3>Aumenta suas habilidades sociais e de relacionamento</h3>
                                <p>Enquanto algumas pessoas são naturalmente extrovertidas, outros são tímidos e têm dificuldade em conhecer novas pessoas. Ser voluntário permite a oportunidade de praticar e desenvolver suas habilidades sociais, uma vez que você está se encontrando regularmente com um grupo de pessoas com interesses comuns. Uma vez que você dá o primeiro passo,
                                    é mais fácil quebrar a timidez e fazer mais amigos e ampliar seus relacionamentos.</p>
                            </div>
                            <div class="col-md-6 text-sm-center service-block"> 
                                <h3>Traz diversão e satisfação para a sua vida</h3>
                                <p>O voluntariado é uma maneira divertida e fácil de explorar seus interesses e paixões. Fazer trabalho voluntário pode ser uma forma interessante e relaxante de quebrar a rotina dos compromissos de trabalho, escola ou família. O voluntariado também pode te 
                                    ajudar a exercitar sua  criatividade, motivação e visão e, isso, pode te ajudar muito na vida pessoal e profissional.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4"> <img src="https://images6.alphacoders.com/456/456498.jpg" class="img-fluid" /> <span align="center">Desenvolvedor web </span> </div>
                </div>
                <!-- /.row --> 
            </div>
        </section>
        ...
        <section class="about-sec parallax-section" id="about">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <h2><small>Proposta: </small>Afinal<br>
                            O que somos?</h2>
                    </div>
                    <div class="col-md-4">
                        <p>A proposta inicial é para que os nossos usuários encontrem em nós uma saída para divulgação de seus trabalhos voluntários.</p>
                        <p>A idéia surgiu de Bianca Garcia estudante de física do Instituto Federal Sudeste de Minas Campus JF. A observação veio ao observar a dificuldade que um trabalhador passa para encontrar uma equipe para a execução de um trabalho.
                        </p>
                    </div>
                    <div class="col-md-4">
                        <p>A maneira que encontramos de solucionar foi através de uma plataforma que iria intermediar esse processo, possibilitando quem queira divulgar seus trabalhos volutários e facilitando os clientes de encontrar e solicitar esses trabalhos.</p>
                        <p>Queremos com essa plataforma elaborar cada vez mais uma melhor interação e experiência que os nossos usuários venham a ter conosco.</p>
